...
from PyQt5.QtCore import QTimer, Qt, QSize, QThread, pyqtSignal, QObject
...
class UIWINDOW(QMainWindow):
    ...
    def __init__(self, app):
        ...
        self.ip_addr = '192.168.250.17'  # Ip Address connection
        ...
        self.video_conn = VideoFeedThread(self.ssh_conn, self.logger, self.ip_addr)
        self.thruster_conn = THRUSTER_HANDLER(self.ssh_conn, self.logger, self.ip_addr)
        ...
        self.sensor_conn = SensorsHandler(self.ssh_conn, self.logger, labels,self.ip_addr)
    ...
    def toggleRovToPiConnection(self, ssh_conn):
        try:
            ...
            self.logger.log(f"Error in toggleRovToPiConnection: {e}")
            self.isSshConnected = False
    ...
    def toggleControllerConnection(self):
        ...
        if self.controller:
            ...
            # pygame.quit()
            self.thruster_conn.disconnect_controller()
            self.controller = None
            self.connectControllerButton.setText("CONNECT")
